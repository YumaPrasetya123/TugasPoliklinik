<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="alert alert-primary shadow-sm" role="alert">
            ...
            <p>Anda login sebagai <strong><?php echo e(Auth::user()->role); ?></strong>. Semoga harimu menyenangkan dan produktif!</p>
        </div>
        ...
        <footer class="text-center mt-4 small text-muted">
            © <?php echo e(date('Y')); ?> Dashboard Admin. Dikembangkan dengan <i class="fas fa-heart text-danger"></i> oleh Tim
            Anda.
        </footer>
    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\poliklinik-udinus-main\resources\views/admin/pages/home/index.blade.php ENDPATH**/ ?>